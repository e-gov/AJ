...
PGPASSWORD=$password psql -U postgres postgresql://localhost -c "CREATE ROLE dumonitor PASSWORD 'md545a9c580a300097b2636906348056c60' NOSUPERUSER NOCREATEDB NOCREATEROLE INHERIT LOGIN;"
...
PGPASSWORD=$password psql -U postgres postgresql://localhost -d dumonitor -c "CREATE ROLE dumonitor_app PASSWORD 'md545a9c580a300097b2636906348056c60' NOSUPERUSER NOCREATEDB NOCREATEROLE INHERIT LOGIN;"
