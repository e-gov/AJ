...
public class Store extends HttpServlet {
  ...
  */
  ...
  private boolean loadProperties(HttpServletResponse resp, ServletOutputStream os) 
  throws ServletException, IOException {
    ...
    try {
      ...
      if (Property.DATABASE_CONNECTSTRING.getString()==null ||
        ...
        showError(1,"failed to load database connect string, user or password configuration properties", 
                 resp, os);    
        return false;    
      }
      ...
      showError(1,"failed to load configuration properties", resp, os);
      return false;
    }
  }
  ...
  throws ServletException, IOException {
    ...
    LOG.error("errcode {} errmessage {}", code, msg);
